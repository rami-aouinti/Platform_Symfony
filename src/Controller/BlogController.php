...
final class BlogController extends AbstractController
{
    ...
    #[Route('/search/post', name: 'blog_post_search', methods: ['GET'])]
    public function searchPostAction(Request $request, PostRepository $posts)
    {
        $requestString = $request->get('q');
        return new Response(json_encode($posts->findBySearchQuery($requestString)));
    }
